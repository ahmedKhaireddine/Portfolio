<template>
	<svg
		...
		x="0px"
		y="0px"
		viewBox="0 0 100 90.963"
		enable-background="new 0 0 100 90.963"
		xml:space="preserve"
		width="23px"
		height="23px"
		fill="currentColor"
	>
		...
		></path>
		<path
			d="M97.012,35.99h-45.13l-3.868-5.13c-0.657-0.872-2.09-1.588-3.177-1.588h-7.923c-1.094,0-2.884,0-3.984,0h-7.917  c-1.094,0-2.526,0.716-3.184,1.588l-3.861,5.13v51.992c0,1.641,1.341,2.981,2.975,2.981h76.068c1.647,0,2.988-1.341,2.988-2.981  V38.984C100,37.331,98.659,35.99,97.012,35.99z"
		></path>
	</svg>
</template>
